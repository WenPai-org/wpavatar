...
function wpavatar_replace_gravatar_text( $translated_text, $text, $domain ) {
	...
	$is_discussion_page = ( 'options-discussion' === $screen_id ||
							( isset( $_GET['page'] ) && 'discussion' === $_GET['page'] ) );

	$is_comments_page = ( 'edit-comments' === $screen_id ||
						'comment' === $screen_id );

	$is_profile_page = ( 'profile' === $screen_id ||
						'user-edit' === $screen_id );
...
function wpavatar_replace_gravatar_text_plural( $translated_text, $single, $plural, $number ) {
	...
	$is_relevant_page = ( 'options-discussion' === $screen_id ||
						'edit-comments' === $screen_id ||
						'comment' === $screen_id ||
						'profile' === $screen_id ||
						'user-edit' === $screen_id ||
						( isset( $_GET['page'] ) && 'discussion' === $_GET['page'] ) );
