...
class Marketing {
	...
	public static function init() {
		// 注册短代码
		add_shortcode( 'wpavatar_latest_commenters', array( __CLASS__, 'render_latest_commenters' ) );
		add_shortcode( 'wpavatar_latest_users', array( __CLASS__, 'render_latest_users' ) );
		add_shortcode( 'wpavatar_random_users', array( __CLASS__, 'render_random_users' ) );
		add_shortcode( 'wpavatar_author', array( __CLASS__, 'render_author_avatar' ) );

		// 添加头像样式
		add_action( 'wp_head', array( __CLASS__, 'add_frontend_styles' ) );
