...
class Settings {
	...
	public static function register_settings() {
		// 注册设置组和设置字段
		register_setting( 'wpavatar_basic', 'wpavatar_enable_cravatar', array( 'type' => 'boolean' ) );
		register_setting( 'wpavatar_basic', 'wpavatar_cdn_type', array( 'type' => 'string' ) );
		register_setting( 'wpavatar_basic', 'wpavatar_cravatar_route', array( 'type' => 'string' ) );
		register_setting( 'wpavatar_basic', 'wpavatar_third_party_mirror', array( 'type' => 'string' ) );
		register_setting( 'wpavatar_basic', 'wpavatar_custom_cdn', array( 'type' => 'string' ) );
		register_setting( 'wpavatar_basic', 'wpavatar_timeout', array( 'type' => 'integer' ) );

		register_setting( 'wpavatar_cache', 'wpavatar_enable_cache', array( 'type' => 'boolean' ) );
		register_setting(
			'wpavatar_cache',
			'wpavatar_cache_path',
			array(
				'type'              => 'string',
				'sanitize_callback' => array( __CLASS__, 'sanitize_cache_path' ),
			)
		);
		register_setting( 'wpavatar_cache', 'wpavatar_cache_expire', array( 'type' => 'integer' ) );

		register_setting( 'wpavatar_advanced', 'wpavatar_seo_alt', array( 'type' => 'string' ) );
		register_setting( 'wpavatar_advanced', 'wpavatar_fallback_mode', array( 'type' => 'boolean' ) );
		register_setting( 'wpavatar_advanced', 'wpavatar_fallback_avatar', array( 'type' => 'string' ) );

		register_setting( 'wpavatar_shortcodes', 'wpavatar_shortcode_size', array( 'type' => 'integer' ) );
		register_setting( 'wpavatar_shortcodes', 'wpavatar_shortcode_class', array( 'type' => 'string' ) );
		register_setting( 'wpavatar_shortcodes', 'wpavatar_shortcode_shape', array( 'type' => 'string' ) );

		// 注册营销组件设置
		register_setting( 'wpavatar_marketing', 'wpavatar_commenters_count', array( 'type' => 'integer' ) );
		register_setting( 'wpavatar_marketing', 'wpavatar_commenters_size', array( 'type' => 'integer' ) );
		register_setting( 'wpavatar_marketing', 'wpavatar_users_count', array( 'type' => 'integer' ) );
		register_setting( 'wpavatar_marketing', 'wpavatar_users_size', array( 'type' => 'integer' ) );
	}
			...
			<div class="wpavatar-section" id="wpavatar-section-basic" style="<?php echo $active_tab !== 'basic' ? 'display: none;' : ''; ?>">
				...
				<div class="wpavatar-network-notice">
					<p>
						...
						<?php if ( array_intersect( array( 'wpavatar_enable_cravatar', 'wpavatar_cdn_type', 'wpavatar_cravatar_route', 'wpavatar_third_party_mirror', 'wpavatar_custom_cdn', 'wpavatar_timeout' ), $network_controlled_options ) ) : ?>
				...
				<form method="post" action="options.php" id="wpavatar-basic-form">
					...
					<table class="form-table">
						<tr>
							...
							<td>
								<label class="wpavatar-switch">
									<input type="checkbox" name="wpavatar_enable_cravatar" value="1" <?php checked( $enable_cravatar ); ?> <?php echo esc_attr( $disabled_enable_cravatar ); ?>>
						...
						<tr>
							...
							<td>
								<label class="wpavatar-radio">
									<input type="radio" name="wpavatar_cdn_type" value="cravatar_route" <?php checked( $cdn_type, 'cravatar_route' ); ?> <?php echo esc_attr( $disabled_cdn_type ); ?>>
									<span class="wpavatar-radio-label"><?php _e( 'Cravatar自选线路', 'wpavatar' ); ?></span>
								</label><br>
								<label class="wpavatar-radio">
									<input type="radio" name="wpavatar_cdn_type" value="third_party" <?php checked( $cdn_type, 'third_party' ); ?> <?php echo esc_attr( $disabled_cdn_type ); ?>>
									<span class="wpavatar-radio-label"><?php _e( '第三方镜像', 'wpavatar' ); ?></span>
								</label><br>
								<label class="wpavatar-radio">
									<input type="radio" name="wpavatar_cdn_type" value="custom" <?php checked( $cdn_type, 'custom' ); ?> <?php echo esc_attr( $disabled_cdn_type ); ?>>
						...
						<tr class="cdn-option cravatar-route-option" <?php echo $cdn_type !== 'cravatar_route' ? 'style="display:none;"' : ''; ?>>
							...
							<td>
								<select name="wpavatar_cravatar_route" class="wpavatar-select" <?php echo esc_attr( $disabled_cravatar_route ); ?>>
						...
						<tr class="cdn-option third-party-option" <?php echo $cdn_type !== 'third_party' ? 'style="display:none;"' : ''; ?>>
							...
							<td>
								<select name="wpavatar_third_party_mirror" class="wpavatar-select" <?php echo esc_attr( $disabled_third_party_mirror ); ?>>
						...
						<tr class="cdn-option custom-cdn-option" <?php echo $cdn_type !== 'custom' ? 'style="display:none;"' : ''; ?>>
							...
							<td>
								<input type="text" name="wpavatar_custom_cdn" value="<?php echo esc_attr( $custom_cdn ); ?>" class="regular-text wpavatar-input" <?php echo esc_attr( $disabled_custom_cdn ); ?>>
						...
						<tr>
							...
							<td>
								<input type="number" name="wpavatar_timeout" value="<?php echo esc_attr( $timeout ); ?>" min="1" max="30" class="small-text wpavatar-input" <?php echo esc_attr( $disabled_timeout ); ?>>
								<?php _e( '秒', 'wpavatar' ); ?>
			...
			<div class="wpavatar-section" id="wpavatar-section-cache" style="<?php echo $active_tab !== 'cache' ? 'display: none;' : ''; ?>">
				...
				<div class="wpavatar-network-notice">
					<p>
						...
						<?php if ( array_intersect( array( 'wpavatar_enable_cache', 'wpavatar_cache_path', 'wpavatar_cache_expire' ), $network_controlled_options ) ) : ?>
							<em><?php _e( '以上选项由网络管理员控制，您的更改将不会生效。', 'wpavatar' ); ?></em>
						<?php endif; ?>
					</p>
				</div>
				...
				<form method="post" action="options.php" id="wpavatar-cache-form">
					...
					<table class="form-table">
						<tr>
							...
							<td>
								<label class="wpavatar-switch">
									<input type="checkbox" name="wpavatar_enable_cache" value="1" <?php checked( $enable_cache ); ?> <?php echo esc_attr( $disabled_enable_cache ); ?>>
									<span class="wpavatar-slider"></span>
						...
						<tr>
							...
							<td>
								<input type="text" name="wpavatar_cache_path" value="<?php echo esc_attr( $cache_path ); ?>" class="regular-text wpavatar-input" <?php echo esc_attr( $disabled_cache_path ); ?>>
								<?php if ( is_multisite() ) : ?>
						...
						<tr>
							...
							<td>
								<input type="number" name="wpavatar_cache_expire" value="<?php echo esc_attr( $cache_expire ); ?>" min="1" max="30" class="small-text wpavatar-input" <?php echo esc_attr( $disabled_cache_expire ); ?>>
								<?php _e( '天', 'wpavatar' ); ?>
			...
			<div class="wpavatar-section" id="wpavatar-section-advanced" style="<?php echo $active_tab !== 'advanced' ? 'display: none;' : ''; ?>">
				...
				<div class="wpavatar-network-notice">
					<p>
						...
						<?php if ( array_intersect( array( 'wpavatar_seo_alt', 'wpavatar_fallback_mode', 'wpavatar_fallback_avatar' ), $network_controlled_options ) ) : ?>
							<em><?php _e( '以上选项由网络管理员控制，您的更改将不会生效。', 'wpavatar' ); ?></em>
						<?php endif; ?>
					</p>
				</div>
				...
				<form method="post" action="options.php" id="wpavatar-advanced-form">
					...
					<table class="form-table">
						<tr>
							...
							<td>
								<input type="text" name="wpavatar_seo_alt" value="<?php echo esc_attr( $seo_alt ); ?>" class="regular-text wpavatar-input" <?php echo esc_attr( $disabled_seo_alt ); ?>>
						...
						<tr>
							...
							<td>
								<label class="wpavatar-switch">
									<input type="checkbox" name="wpavatar_fallback_mode" value="1" <?php checked( $fallback_mode ); ?> <?php echo esc_attr( $disabled_fallback_mode ); ?>>
									<span class="wpavatar-slider"></span>
						...
						<tr>
							...
							<td>
								<div class="default-avatar-options">
									...
									<label>
										<input type="radio" name="wpavatar_fallback_avatar" value="<?php echo esc_attr( $key ); ?>" <?php checked( $fallback_avatar, $key ); ?> <?php echo esc_attr( $disabled_fallback_avatar ); ?>>
			...
			<div class="wpavatar-section" id="wpavatar-section-shortcodes" style="<?php echo $active_tab !== 'shortcodes' ? 'display: none;' : ''; ?>">
				...
				<div class="wpavatar-network-notice">
					<p>
						...
						<?php if ( array_intersect( array( 'wpavatar_shortcode_size', 'wpavatar_shortcode_class', 'wpavatar_shortcode_shape' ), $network_controlled_options ) ) : ?>
							<em><?php _e( '以上选项由网络管理员控制，您的更改将不会生效。', 'wpavatar' ); ?></em>
						<?php endif; ?>
					</p>
				</div>
				...
				<div class="wpavatar-preview-container">
					...
					<div class="wpavatar-preview-wrapper">
						...
						<div class="wpavatar-preview-item">
							<h4><?php _e( '方形', 'wpavatar' ); ?></h4>
							<img src="<?php echo esc_url( WPAVATAR_PLUGIN_URL ); ?>assets/images/wapuu-china.png" width="80" height="80" class="avatar-square">
						</div>
						<div class="wpavatar-preview-item">
							<h4><?php _e( '圆角', 'wpavatar' ); ?></h4>
							<img src="<?php echo esc_url( WPAVATAR_PLUGIN_URL ); ?>assets/images/wapuu-china.png" width="80" height="80" class="avatar-rounded" style="border-radius:8px">
						</div>
						<div class="wpavatar-preview-item">
							<h4><?php _e( '圆形', 'wpavatar' ); ?></h4>
							<img src="<?php echo esc_url( WPAVATAR_PLUGIN_URL ); ?>assets/images/wapuu-china.png" width="80" height="80" class="avatar-circle" style="border-radius:50%">
						</div>
					</div>
				...
				<form method="post" action="options.php" id="wpavatar-shortcodes-form">
					...
					<table class="form-table">
						<tr>
							...
							<td>
								<input type="number" name="wpavatar_shortcode_size" value="<?php echo esc_attr( $shortcode_size ); ?>" min="16" max="512" class="small-text wpavatar-input" <?php echo esc_attr( $disabled_shortcode_size ); ?>>
						...
						<tr>
							...
							<td>
								<input type="text" name="wpavatar_shortcode_class" value="<?php echo esc_attr( $shortcode_class ); ?>" class="regular-text wpavatar-input" <?php echo esc_attr( $disabled_shortcode_class ); ?>>
						...
						<tr>
							...
							<td>
								<select name="wpavatar_shortcode_shape" class="wpavatar-select" <?php echo esc_attr( $disabled_shortcode_shape ); ?>>
			...
			<div class="wpavatar-section" id="wpavatar-section-marketing" style="<?php echo $active_tab !== 'marketing' ? 'display: none;' : ''; ?>">
				...
				<div class="wpavatar-network-notice">
					<p>
						...
						<?php if ( array_intersect( array( 'wpavatar_commenters_count', 'wpavatar_commenters_size', 'wpavatar_users_count', 'wpavatar_users_size' ), $network_controlled_options ) ) : ?>
							<em><?php _e( '以上选项由网络管理员控制，您的更改将不会生效。', 'wpavatar' ); ?></em>
						<?php endif; ?>
					</p>
				</div>
